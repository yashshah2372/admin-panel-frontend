...
const AddPropButton = styled( Button )({
  ...
  function createData(id, name, email, contact, date,status) {
    return {id, name, email, contact, date,status };
  }
  
  const rows = [
    createData('#0001', "Nirmal Bisht", "enquiry@ag-enterprises.com", "9464955655", `11/05/2022 05:00 PM`, 1,),
    createData('#0001', "Nirmal Bisht", "enquiry@ag-enterprises.com", "9464955655", `11/05/2022 05:00 PM`, 0,),
    createData('#0001', "Nirmal Bisht", "enquiry@ag-enterprises.com", "9464955655", `11/05/2022 05:00 PM`, 1,),
    createData('#0001', "Dattaraj Constructions", "nirmalshrma123@gmail.com", "9464955655", `11/05/2022 05:00 PM`, 1,),
    createData('#0001', "Dattaraj Constructions", "nirmalshrma123@gmail.com", "9464955655", `11/05/2022 05:00 PM`, 0,),
    createData('#0001', "Dattaraj Constructions", "nirmalshrma123@gmail.com", "9464955655", `11/05/2022 05:00 PM`, 0,),
  ];
  ...
  return (
    <div className="p-4">
        <div style={styledBoxTop}>
          ...
          <AddPropButton onClick={handleOpen} size="medium" variant="outlined" endIcon={<img src={leadIcon} />}>Add Lead</AddPropButton>
        </div>
        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <StyledTableCell align="center"><div style={{
                  minWidth: "81px",
                  maxWidth: "81px",
                  ...
                  borderRadius: "3px",
                  fontSize: "11px",
              }}>{row.status ? "Processing" : "Site Visit"}</div></StyledTableCell>
